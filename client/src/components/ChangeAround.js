    ...
    return ( 
       ...
       <div> 
            ...
            <form id="form" action={`/edit${entryId}`} method='POST'>
                        Title:<br></br><input type="text" placeholder={entry.title}></input><br></br>
                        Author:<br></br><input type="text" placeholder={entry.author} ></input><br></br>
                        Content:<br></br><input type="text" placeholder={entry.content}></input><br></br>
                           Tags: <br></br><select name="tags" id="tags">
                            ...
                            <button>Delete This Post</button><br></br>
